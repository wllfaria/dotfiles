...
local appearance         = require("theme.appearance")
...
theme.titlebarType       = appearance.titlebarType
theme.barDir             = appearance.barDir
theme.barPadding         = appearance.gaps
theme.barSize            = appearance.barSize
theme.dockSize           = appearance.dockSize
theme.barShouldHaveGaps  = appearance.barShouldHaveGaps

theme.scrheight          = appearance.scrheight
theme.scrwidth           = appearance.scrwidth
...
theme.useless_gap        = math.ceil(appearance.gaps / 4)
...
theme.notification_width       = dpi(625)
