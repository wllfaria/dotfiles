...
static const char *fonts[]          = { "JetBrainsMono Nerd Font Mono:size=12",
		...
		"JetBrainsMono Nerd Font Mono:size=8:antialias=true:autohint=true"};
...
static const char col_gray2[]       = "#242837";
static const char col_gray3[]       = "#504945";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#005577";
static const char col_blue[]         = "#7986E7";
static const char col_fg[]          = "#e4e4e4";
static const unsigned int baralpha = 0xd0;
static const unsigned int borderalpha = 100;
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg, col_gray1, col_gray2 },
	[SchemeSel]  = { col_fg, col_blue,  col_gray3  },
	[SchemeStatus]  = { col_fg, col_gray1,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_fg, col_blue,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
    [SchemeTagsNorm]  = { col_fg, col_gray1,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
    [SchemeInfoSel]  = { col_fg, col_gray1,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_fg, "-sb", col_blue, "-sf", col_fg, NULL };
