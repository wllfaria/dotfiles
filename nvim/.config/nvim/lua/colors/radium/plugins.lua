...
M.neogit = function(config)
    ...
    return {
        ...
        NeogitDiffAdd = transparent and { bg = nil, fg = colors.blue_bright } or
            { bg = "#16191D", fg = "#7AB0DF", },
        NeogitDiffAddHighlight = transparent and { bg = nil, fg = colors.blue_bright } or
            { bg = "#16191D", fg = "#7AB0DF", },
        NeogitDiffContextHighlight = { bg = "#1A1D24", },
        NeogitDiffDelete = transparent and { bg = nil, fg = colors.red, } or
            { bg = "#1C1F22", fg = "#F87070", },
        NeogitDiffDeleteHighlight = transparent and { bg = nil, fg = colors.red, } or
            { bg = "#1C1F22", fg = colors.red, },
