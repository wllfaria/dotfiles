...
local sep = wibox.widget({
	markup = '<span color="' .. color_list.green .. '" font="Ubuntu Nerd Font bold 10">' .. "" .. "</span>",
	font = "Ubuntu Nerd Font 14",
	widget = wibox.widget.textbox,
	fg = color_list.white,
...
local hour_clock =
	wibox.widget.textclock('<span color="' .. color_list.yellow .. '" font="Ubuntu Nerd Font Bold 36"> %H </span>', 10)

local minute_clock =
	wibox.widget.textclock('<span color="' .. color_list.yellow .. '" font="Ubuntu Nerd Font Bold 36"> %M </span>', 10)

local date_text = wibox.widget.textclock(
	'<span color="' .. color_list.magenta .. '" font="Ubuntu Nerd Font Bold 14"> %a, %d </span>',
	10
)
